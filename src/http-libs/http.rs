    ...
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            HttpError::MethodNotAllowed(err_code, msg) =>
                write!(f, "Error {}: Method Not Allowed {}", *err_code as u16, msg),
            HttpError::NotAcceptable(err_code, msg) =>
                write!(f, "Error {}: Not Acceptable {}", *err_code as u16, msg),
            HttpError::Conflict(err_code, msg) =>
                write!(f, "Error {}: Conflict {}", *err_code as u16, msg),
            ...
            HttpError::BadGateway(err_code, msg) =>
                write!(f, "Error {}: Bad Gateway {}", *err_code as u16, msg),
